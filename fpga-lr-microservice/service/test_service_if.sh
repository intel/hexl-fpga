...
test_service_if -ncards=1 -data=kaggle_homecreditdefaultrisk -chunk_size=40 -poly_modulus_degree=16384 -coeff_mod_bit_sizes=52,52,52,50,50,45,27 -scale_bit_size=48 -security_lvl=128
