...
#include <L0/twiddle-factors.hpp>
 ...
 private:
  ...
  using pipe_NTT_write_in =
      ext::intel::pipe<NTTWriteInPipeId<id>, L0::WideVector_t<VEC>,
                       coeff_count / 2 / VEC>;
  using pipe_NTT_tf =
      ext::intel::pipe<NTTTFPipeId<id>, L0::TwiddleFactor_t<VEC>,
                       coeff_count / VEC>;
