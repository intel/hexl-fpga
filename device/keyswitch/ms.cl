...
void _ms(moduli_t moduli, uint64_t coeff_count, uint64_t decomp_modulus_size,
  ...
  while (true) {
    ...
    switch (i) {
      case 5:
        t_ith_poly = read_channel_intel(ch_t_poly_prod_iter[5][key_component]);
        break;
      case 4:
        t_ith_poly = read_channel_intel(ch_t_poly_prod_iter[4][key_component]);
        break;
      case 3:
        t_ith_poly = read_channel_intel(ch_t_poly_prod_iter[3][key_component]);
        break;
      case 2:
        t_ith_poly = read_channel_intel(ch_t_poly_prod_iter[2][key_component]);
        break;
      case 1:
        t_ith_poly = read_channel_intel(ch_t_poly_prod_iter[1][key_component]);
        break;
      default:
        t_ith_poly = read_channel_intel(ch_t_poly_prod_iter[0][key_component]);
        break;
    }
    ...
    uint64_t arg1_val = ReduceMod(InputModFactor, in, modulus, &twice_modulus,
                                  &four_times_modulus);
